...
use crate::domain::{errors::repository_error::RepositoryError, models::payment::Payment};

#[async_trait::async_trait]
pub trait PaymentRepository: Send + Sync {
    async fn persist_payment(&self, payment: &Payment) -> Result<(), RepositoryError>;

    async fn get_payment_by_ref(&self, reference: &str)
    ...
    async fn get_weekly_revenue(&self, date: NaiveDate)
